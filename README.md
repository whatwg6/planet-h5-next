...
- Route entry components should render through `RouteModeSwitch`; put the normal page in `defaultPage`, add mode branches in `modes`, and do not read `location.state` from feature views.
