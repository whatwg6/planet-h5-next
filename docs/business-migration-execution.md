...
This execution guide is based on `docs/business-migration-plan.md`. If the migration plan changes, update this guide to keep the execution slices aligned with the plan.
