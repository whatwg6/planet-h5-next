...
| Business capabilities | `src/biz/features/payment-method`, `src/biz/features/client-member`, `src/biz/features/select-merchant`, `src/biz/features/select-mc-staff`, `src/biz/comps` | Capability props, validation, local state, save handoff           |
...
| `mcCard`, `externalCard`                                                                                                                                                                  | `features/card-setting` capability          |
